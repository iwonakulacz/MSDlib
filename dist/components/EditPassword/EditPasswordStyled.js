...
export var DotsWrapperStyled = styled.div(_templateObject4(), function (props) {
  return props.currentStep && css(_templateObject5(), props.currentStep, MyAccountMenuActive);
});
...
export var TextStyled = styled.p(_templateObject16(), MainColor, function (props) {
