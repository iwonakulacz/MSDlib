...
import { MainColor, BackgroundColor, LineColor, ErrorColor } from 'styles/variables';
export var WrapStyled = styled.div(_templateObject(), function (props) {
  return props.hideInput && css(_templateObject2());
});
export var InputElementLabelStyled = styled.label(_templateObject3(), MainColor);
export var InputElementStyled = styled.input(_templateObject4(), LineColor, LineColor, BackgroundColor, MainColor, function (props) {
