...
import { CheckboxStyled, CheckFrameStyled, CheckMarkStyled } from './CheckboxStyled';
describe('<Checkbox/>', function () {
  describe('@renders', function () {
    it('should render initial state', function () {
      var wrapper = shallow( /*#__PURE__*/React.createElement(Checkbox, null));
  ...
  describe('@events', function () {
    ...
    it('should call onClickFn when press Enter on checkbox', function () {
      ...
      var checkbox = wrapper.find(CheckFrameStyled);
      expect(clickFn).not.toHaveBeenCalled();
