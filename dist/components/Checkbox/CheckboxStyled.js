...
import { MainColor, ErrorColor, ConfirmColor, LineColor, FocusColor } from 'styles/variables';
import tickIcon from 'assets/images/input/tick.svg';
import enableIcon from 'assets/images/input/enable_check.svg';
export var CheckboxStyled = styled.div(_templateObject(), MainColor, function (props) {
  return props.disabled && css(_templateObject2());
});
export var ConsentDefinitionStyled = styled.div(_templateObject3(), MainColor, FocusColor, function (props) {
  return props.checked && css(_templateObject4());
});
export var CheckFrameStyled = styled.div(_templateObject5(), LineColor, FocusColor, function (props) {
  return props.error && css(_templateObject6(), ErrorColor);
}, function (props) {
  return props.isRadioButton && css(_templateObject7());
}, function (props) {
  return props.isRadioButton && props.checked && css(_templateObject8(), ConfirmColor);
}, function (props) {
  return props.isMyAccount && props.checked && css(_templateObject9(), ConfirmColor);
});
export var CheckMarkStyled = styled.div(_templateObject10(), tickIcon, function (props) {
