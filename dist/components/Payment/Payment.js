...
const Payment = /* #__PURE__ */ (function(_Component) {
  _inherits(Payment, _Component);

  const _super = _createSuper(Payment);
  ...
  function Payment(props) {
    ...
    _this.onAdyenSubmit = function(_ref) {
      const card = _ref.data.paymentMethod;
    ...
    _this.choosePaymentMethod = function(methodId, methodName) {
      ...
      if (orderId) {
        updateOrder(orderId, {
          ...
          const { updatePriceBreakdown } = _this.props;
  ...
  _createClass(Payment, [
    {
      ...
      value: (function() {
        const _componentDidMount = _asyncToGenerator(
    ...
    },
    {
      ...
      value: function render() {
        ...
        const { isPaymentDetailsRequired } = _this$props3;
        const { t } = _this$props3;
        const _this$state = this.state;
        const { isPaymentFormDisplayed } = _this$state;
        const { generalError } = _this$state;
        const { paymentMethods } = _this$state;
        const { isPayPal } = _this$state;
                ...
                /* #__PURE__ */ React.createElement(
                  ...
                  paymentMethods.map(function(method) {
                    return (
                      ...
                      /* #__PURE__ */ React.createElement(PaymentMethodButton, {
                        key: method.id,
