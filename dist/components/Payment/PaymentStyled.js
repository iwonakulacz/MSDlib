...
export var PaymentStyled = styled.div(
  _templateObject(),
  colors.BackgroundColor,
  colors.LineColor,
  colors.LineColor
);
export var PaymentErrorStyled = styled.div(
  _templateObject2(),
  colors.ErrorColor
);
export var MethodsWrapperStyled = styled.div(
  _templateObject3(),
  colors.MediumGrey,
  media.smallest(_templateObject4())
);
export var PayPalWrapperStyled = styled.div(_templateObject5());
export var PayPalTextStyled = styled.p(
  _templateObject6(),
