...
export var WrapStyled = styled.header(
  _templateObject(),
  mediaFrom.small(_templateObject2(), LineColor)
);
export var PhotoStyled = styled.div(
  _templateObject3(),
  portrait,
  mediaFrom.small(_templateObject4())
);
export var NameStyled = styled.div(
  _templateObject5(),
  MainColor,
  mediaFrom.small(_templateObject6())
);
export var MailStyled = styled.div(
  _templateObject7(),
  MainColor,
  SmallFont,
  function(props) {
...
export var DetailsStyled = styled.div(
  _templateObject11(),
  MainColor,
  function(props) {
    return (
