...
storiesOf('Checkout/Consents', module).addDecorator(jsxDecorator).addDecorator(withKnobs).addDecorator(withMock).addDecorator(function (story) {
  ...
  return /*#__PURE__*/React.createElement(Consent, {
