...
storiesOf('MyAccount/UpdateProfile/Consents', module).addDecorator(jsxDecorator).addDecorator(withKnobs).addDecorator(function (story) {
  ...
  return /*#__PURE__*/React.createElement(PureMyAccountConsents, {
