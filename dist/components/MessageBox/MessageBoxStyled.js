...
export var MessageBoxStyled = styled.div(_templateObject(), BackgroundColor, LineColor);
export var MessageBoxIconWrapStyled = styled.div(_templateObject2(), ConfirmColor);
export var MessageBoxMessageStyled = styled.div(_templateObject3(), ConfirmColor);