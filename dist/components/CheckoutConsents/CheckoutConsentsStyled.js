...
export var CheckoutConsentsContentStyled = styled.div(
  _templateObject2(),
  media.small(_templateObject3())
);
export var CheckoutConsentsTitleStyled = styled.h3(
  _templateObject4(),
  colors.MainColor
);
export var CheckoutConsentsSubTitleStyled = styled.h4(
  _templateObject5(),
  colors.MediumGrey
);
...
export var CheckoutConsentsError = styled.div(
  _templateObject8(),
  colors.ErrorColor,
  function(props) {
