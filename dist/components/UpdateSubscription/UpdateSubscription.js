...
import { ReasonsWrapper, StyledItem, StrongStyled } from './UpdateSubscriptionStyled';
...
var UpdateSubscription = /*#__PURE__*/function (_Component) {
  ...
  function UpdateSubscription(props) {
    ...
    _this.unsubscribe = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    ...
    _this.resubscribe = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
  ...
  _createClass(UpdateSubscription, [{
    ...
    value: function render() {
      ...
      var popupContent = content[action][currentStep - 1];
      var resubscribeText = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("b", null, "".concat(priceRounded).concat(currency)), " ", t(popupContent.startedFrom), ' ', /*#__PURE__*/React.createElement("b", null, dateFormat(offerDetails.expiresAt), "."));
      return /*#__PURE__*/React.createElement(InnerPopupWrapper, {
        steps: 2,
        popupTitle: t('Manage your plan'),
        isError: isError,
        currentStep: currentStep
      }, currentStep === 1 ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ContentStyled, null, /*#__PURE__*/React.createElement(TitleStyled, null, t(popupContent.title)), /*#__PURE__*/React.createElement(TextStyled, null, t(popupContent.text1), ' ', /*#__PURE__*/React.createElement(StrongStyled, null, t(popupContent.buttonText)), ' ', t(popupContent.text2), ' ', action === 'resubscribe' && resubscribeText), popupContent.reasons && /*#__PURE__*/React.createElement(ReasonsWrapper, null, cancellationReasons.map(function (reason) {
      ...
      }, t('No, thanks')), /*#__PURE__*/React.createElement(Button, {
        ...
        buttonLoader: true,
        color: "#ffffff"
      }) || t(popupContent.buttonText)))) : /*#__PURE__*/React.createElement(ContentStyled, null, /*#__PURE__*/React.createElement("img", {
        src: checkmarkIcon,
        alt: "checkmark icon"
      }), /*#__PURE__*/React.createElement(TitleStyled, null, t(popupContent.title)), /*#__PURE__*/React.createElement(TextStyled, null, t(popupContent.text), ' ', action === 'resubscribe' && resubscribeText, /*#__PURE__*/React.createElement("b", null, dateFormat(offerDetails.expiresAt)), "."), /*#__PURE__*/React.createElement(Button, {
        width: "auto",
