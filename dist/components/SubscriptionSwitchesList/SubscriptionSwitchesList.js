...
const SubscriptionSwitchesList = function SubscriptionSwitchesList(_ref) {
  const { switchSettings } = _ref;
  const { showInnerPopup } = _ref;
  const { isOfferSelected } = _ref;
  ...
  return /* #__PURE__ */ React.createElement(
    ...
    null,
    areAvailable &&
      switchSettings.available.map(function(subItem) {
        return /* #__PURE__ */ React.createElement(
          SubscriptionStyled,
          {
    ...
    areUnAvailable &&
      switchSettings.unavailable.map(function(subItem) {
        return /* #__PURE__ */ React.createElement(
          SubscriptionStyled,
          {
            key: subItem.toOfferId
