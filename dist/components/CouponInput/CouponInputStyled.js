...
export var InputComponentStyled = styled.div(_templateObject(), function(
  props
) {
  return props.fullWidth && props.isOpened && css(_templateObject2());
});
export var MessageStyled = styled.div(
  _templateObject3(),
  function(props) {
    return props.messageType === MESSAGE_TYPE_SUCCESS
      ? Colors.ConfirmColor
      : Colors.ErrorColor;
  },
  function(props) {
  ...
  function(props) {
    return (
      ...
      css(
        ...
        props.fullWidth && css(_templateObject8())
      )
    );
  },
  function(props) {
...
export var CloseButtonStyled = styled.button(
  _templateObject10(),
  Colors.LineColor,
  Colors.White,
  function(props) {
