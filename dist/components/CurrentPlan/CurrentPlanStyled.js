...
export var SubscriptionStyled = styled.div(_templateObject2(), White, LineColor, function (props) {
  return props.onClick && props.cursorPointer && css(_templateObject3());
}, ConfirmColor, function (props) {
  return props.isSelected && css(_templateObject4());
});
export var SubscriptionActionsStyled = styled.div(_templateObject5(), IconsColor);
export var SimpleButtonStyled = styled(Button)(_templateObject6(), mediaFrom.small && css(_templateObject7()));
export var FullWidthButtonStyled = styled(Button)(_templateObject8(), mediaFrom.small && css(_templateObject9()));
