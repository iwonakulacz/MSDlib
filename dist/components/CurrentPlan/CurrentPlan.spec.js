...
import { SubscriptionStyled, SimpleButtonStyled, FullWidthButtonStyled } from './CurrentPlanStyled';
...
describe('<PlanDetails/>', function () {
  ...
  describe('@renders', function () {
    it('should render initial state without subscriptions', function () {
      var wrapper = mount( /*#__PURE__*/React.createElement(PureCurrentPlan, {
  ...
  describe('@actions', function () {
    ...
    it('should save data about offer to switch on click SubscriptionCard', function () {
      ...
      wrapper.find(SubscriptionStyled).first().simulate('click');
