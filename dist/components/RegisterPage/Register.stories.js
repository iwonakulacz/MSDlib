...
storiesOf('Pages/RegisterPage', module).addDecorator(withKnobs).addDecorator(jsxDecorator).addDecorator(withMock).addDecorator(function (story) {
...
}).addDecorator(StoryRouter()).add('Basic Register', function () {
  return /*#__PURE__*/React.createElement(PureRegister, {
    urlProps: {
      location: {
