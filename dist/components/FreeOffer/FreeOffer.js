...
const FreeOffer = /* #__PURE__ */ (function(_Component) {
  _inherits(FreeOffer, _Component);

  const _super = _createSuper(FreeOffer);
  ...
  function FreeOffer(props) {
    ...
    _this.generateDescriptionForFreeOffer = function(
      period,
      expiresAt,
      startTime
    ) {
  ...
  _createClass(FreeOffer, [
    {
      ...
      value: function render() {
        ...
        const { icon } = _this$props2;
        const { period } = _this$props2;
        const { expiresAt } = _this$props2;
        const { startTime } = _this$props2;
        const { title } = _this$props2;
