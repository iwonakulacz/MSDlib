    ...
    return /* #__PURE__ */ (function(_React$Component) {
      ...
      _createClass(_class, [
        ...
        },
        {
          key: 'addTranslations',
          value: (function() {
            const _addTranslations = _asyncToGenerator(
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 3:
                          ...
                          _context.next = 7;
                          return fetch(
                            '/locales/'.concat(language, '/translations.json')
                          )
        ...
        },
        {
          ...
          value: function render() {
            const { dataLoaded } = this.state; // ... and renders the wrapped component with the fresh data!
