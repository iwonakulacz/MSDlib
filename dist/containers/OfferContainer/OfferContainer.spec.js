...
describe('<OfferContainer/>', function () {
  ...
  describe('@renders', function () {
    it('should show Loader when no offer details', function () {
      var wrapper = mount( /*#__PURE__*/React.createElement(OfferContainer, {
    ...
    it('should render error page when offer is blocked for country', function () {
      var wrapper = mount( /*#__PURE__*/React.createElement(PureOfferContainer, {
        urlProps: mockUrlProps,
        onPaymentComplete: jest.fn()
      }));
      wrapper.setState({
  ...
  describe('@actions', function () {
    it('should apply valid coupon on submit', function (done) {
      var wrapper = shallow( /*#__PURE__*/React.createElement(PureOfferContainer, {
        urlProps: mockUrlProps,
        onPaymentComplete: jest.fn()
      }));
      wrapper.setState({
      ...
      setImmediate(function () {
        ...
        expect(wrapper.state().couponProps.messageType).toBe(MESSAGE_TYPE_SUCCESS);
        done();
      });
    });
