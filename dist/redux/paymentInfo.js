...
export var SET_TRANSACTIONS_LIST_AS_FETCHED = 'SET_TRANSACTIONS_LIST_AS_FETCHED';
export var setTransactionsListAsFetched = createAction(SET_TRANSACTIONS_LIST_AS_FETCHED);
...
var paymentMethodReducer = createReducer(initialState, {
