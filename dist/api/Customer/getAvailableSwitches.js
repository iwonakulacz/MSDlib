...
var getAvailableSwitches = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(offerId) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(ENVIRONMENT_CONFIGURATION.API_URL, "/customers/").concat(customerId, "/subscription_switches/").concat(offerId, "/availability");
