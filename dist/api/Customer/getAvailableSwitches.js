...
const getAvailableSwitches = /* #__PURE__ */ (function() {
  const _ref = _asyncToGenerator(
    /* #__PURE__ */ _regeneratorRuntime.mark(function _callee(offerId) {
      let token;
      let decoded;
      let customerId;
      let url;
          ...
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              url = ''
                ...
                .concat(customerId, '/subscription_switches/')
                .concat(offerId, '/availability');
