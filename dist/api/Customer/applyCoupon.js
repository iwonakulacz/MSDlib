...
var applyCoupon = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(subscriptionId, couponCode) {
    var token, decoded, customerId, url, resp, json;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(ENVIRONMENT_CONFIGURATION.API_URL, "/customers/").concat(customerId, "/subscriptions/").concat(subscriptionId);
            _context.next = 6;
            return fetch(url, {
              method: 'PATCH',
              body: JSON.stringify({
