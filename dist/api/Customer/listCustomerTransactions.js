...
const listCustomerTransactions = /* #__PURE__ */ (function() {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              limit =
                _args.length > 0 && _args[0] !== undefined ? _args[0] : 50;
              offset =
                _args.length > 1 && _args[1] !== undefined ? _args[1] : 0;
              token = getData('CLEENG_AUTH_TOKEN') || '';
              decoded = jwtDecode(token);
              customerId = decoded.customerId;
              url = ''
                .concat(ENVIRONMENT_CONFIGURATION.API_URL, '/customers/')
                .concat(customerId, '/transactions?limit=')
                .concat(limit, '&offset=')
                .concat(offset);
