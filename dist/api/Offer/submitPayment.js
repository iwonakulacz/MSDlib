...
var submitPayment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(card) {
    var token, orderId, url, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(ENVIRONMENT_CONFIGURATION.API_URL, "/connectors/adyen/payments");
            _context.prev = 3;
            _context.next = 6;
            return fetch(url, {
              method: 'POST',
