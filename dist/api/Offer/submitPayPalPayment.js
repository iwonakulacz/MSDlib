...
var submitPayPalPayment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var token, orderId, url, redirectUrls, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(ENVIRONMENT_CONFIGURATION.API_URL, "/connectors/paypal/v1/tokens");
            redirectUrls = {
              successUrl: getData('CLEENG_PP_SUCCESS') || "".concat(window.location.origin, "/thankyou"),
              cancelUrl: getData('CLEENG_PP_CANCEL') || "".concat(window.location.origin, "/offer"),
              errorUrl: getData('CLEENG_PP_ERROR') || "".concat(window.location.origin, "/offer")
            };
            _context.prev = 4;
            _context.next = 7;
            return fetch(url, {
